    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(request.getParameter("idcategorie")!=null){
                ...
                List<BaseModele> listes= getlist.findViewCategorie(idCategorie);
                ViewCategorie temp;
                out.println("<option value='all'>Toutes sous categorie</option>");
                for(BaseModele bm : listes){
                      temp = (ViewCategorie) bm;               
                      out.println("<option value="+temp.getIdSousCategorie()+">"+temp.getNomSousCategorie()+"</option>");
                }                
            }
