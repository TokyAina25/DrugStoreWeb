...
public class SearchController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(souscategorie.compareTo("all")==0){
                souscategorie=null;
            }
             if(categorie.compareTo("all")==0){
                categorie=null;
            }
             if(key!=null){
                 List<BaseModele> lst = getListes.findAllAffichesProduits(key, categorie, souscategorie);
                 request.setAttribute("produits", lst);
                 RequestDispatcher disp = request.getRequestDispatcher("index.jsp?contenue=search");
